  ...
  <div class="w-80 bg-white border-r border-gray-200 flex flex-col h-full">
    ...
    <div class="p-4 border-b border-gray-200 bg-[#014f86] text-white">
      <div class="flex items-center justify-between">
        ...
        <button
          @click="$emit('logout')"
          class="text-white hover:cursor-pointer hover:bg-[#2a6f97] rounded-lg p-2 transition-colors"
          title="Logout"
        >
      ...
      <div v-else class="space-y-1 p-2">
        ...
        >
          ...
          <div class="relative">
            ...
            <div
              v-if="conversation.type === 'direct' && isUserOnline(getDirectChatPartner(conversation)?.id)"
            ...
            <div class="flex items-center justify-between mt-1">
              <p class="text-sm text-gray-600 truncate">
                <span v-if="conversation.lastMessage">
                  <span v-if="conversation.lastMessage.sender?.id === currentUser?.id" class="text-gray-500">You: </span>
