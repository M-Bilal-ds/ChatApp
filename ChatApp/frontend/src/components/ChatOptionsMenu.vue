<template>
  <div v-if="isOpen" class="relative">
    ...
    <div
      ref="menuRef"
      class="absolute right-0 top-12 w-56 bg-white rounded-lg shadow-lg border border-gray-200 z-50"
      @click.stop
    >
      <div class="py-2">
        <!-- Select Messages -->
        ...
        <template v-if="isGroup && isAdmin">
          ...
          <!-- Remove Participants -->
          <button
            @click="showRemoveParticipantsDialog = true"
        ...
        <button 
  @click="console.log('Initial delete conversation clicked'); confirmAction('deleteConversation')"
...
>
  {{ getConfirmButtonText() }}
    ...
    <div
      v-if="showRemoveParticipantsDialog"
      class="fixed inset-0 bg-black/40 backdrop-blur-sm flex items-center justify-center z-50"
    ...
    >
      <div class="bg-white rounded-lg p-6 max-w-md w-full mx-4" @click.stop>
        ...
        <div class="flex justify-end space-x-3 mt-6">
          ...
          <button
            @click="handleRemoveParticipants"
...
const confirmAction = (action: string) => {
  ...
  // DON'T emit close here - let the dialog handle it
}
