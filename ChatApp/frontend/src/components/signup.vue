<template>
  <div class="grid md:grid-cols-2 gap-16 items-center">
    <!-- Left Side - Form -->
    <div class="bg-white rounded-2xl shadow-sm px-16 py-20 min-w-lg">
      <!-- Header -->
      ...
      <form @submit.prevent="handleSignup" class="space-y-6">
        ...
        <button
          type="submit"
          :disabled="isLoading"
          class="w-full flex hover:cursor-pointer justify-center py-2 px-4 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-[#014f86] hover:bg-[#013a63] focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 disabled:opacity-50 disabled:cursor-not-allowed"
        >
    ...
    <div class="max-w-lg">
      <!-- Illustration -->
      <div class="mb-8 bg-[#F0F0F0] rounded-2xl shadow-sm">
        <div class="relative">
          ...
          <div class="flex justify-center">
            <div class="flex -space-x-4">
              <img src="../assets/avatar.jpg" alt="Avatar" class="w-lg h-lg rounded-2xl" >
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="flex items-start">
          <div class="flex-shrink-0">
            <div class="bg-blue-100 p-2 rounded-lg">
              <svg class="w-5 h-5 text-[#014f86]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
